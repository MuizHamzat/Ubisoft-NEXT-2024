...
#define APP_VIRTUAL_WIDTH		(1024)					// This will be the effective x resolution regardless of actual screen/window res. (1024)
#define APP_VIRTUAL_HEIGHT		(600)					// This will be the effective y resolution regardless of actual screen/window res. (768)
